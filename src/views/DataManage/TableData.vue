<template>
  <div class="table-data">
      ...
      <el-row>
        <el-col :span="6">
          <div class="grid-content bg-purple">
            ...
            >
              <el-option label="待引入" value="0"></el-option>
              <el-option label="待审批" value="1"></el-option>
              <el-option label="审批完成" value="2"></el-option>
              <el-option label="引入完成" value="3"></el-option>              
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-input size="small" v-model="searchVal" placeholder="请输入网站名或网站域名"></el-input>
    ...
    >
      ...
      <el-table-column width="60" label="地市" prop="city" align="center"></el-table-column>
      <el-table-column width="60" label="进度" prop="flow_status" align="center"></el-table-column>
      <el-table-column fit label="网站名称" prop="net_name" align="center"></el-table-column>
      <el-table-column fit label="域名" prop="domain" align="center"></el-table-column>
      <el-table-column width="80" label="引入方式" prop="import_type" align="center"></el-table-column>
      <el-table-column width="150" label="备案号" prop="ict" align="center"></el-table-column>
      <el-table-column width="100" label="引入日期" prop="import_date" align="center"></el-table-column>
      <el-table-column width="120" label="备注" prop="memo" align="center"></el-table-column>
      ...
      <el-table-column v-if="getUser.key != 'visitor'" label="操作" width="160" align="center">
        <template slot-scope="scope">
          <el-button
            ...
            size="mini"
            :disabled="scope.row.flow_status!='待引入' && getUser.key !='admin'  "
          >编辑</el-button>
          <el-button
